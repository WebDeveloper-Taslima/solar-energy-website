! function() {
    ...
    SR7.migrate ? ? = {}, SR7.migrate.stgTrans = {
        ...
        let r = {
            ...
            default: {
                fluid: {
                    tx: e.def ? .autoResponsive ? ? !0,
                    tr: e.def ? .autoResponsive ? ? !0,
                    sp: e.def ? .responsiveOffset ? ? !0,
                    alien: e.def ? .responsiveChilds ? ? !0
                },
                len: e.def ? .delay ? ? 9e3
            },
            codes: {
            ...
            slideshow: {
                ...
                firstSlide: e.general ? .firstSlide ? .alternativeFirstSlideSet ? e.general ? .firstSlide ? .alternativeFirstSlide ? ? "auto" : "auto"
            },
            general: {
        ...
        a = (e, t, r, a) => {
            ...
            return null == e ? {
                ...
                video: SR7.D.contentOBJ("video", {
                    ...
                    aFullScreen: !1,
                    mute: !0,
                    args: "vimeo" == e.type ? e.video ? .argsVimeo ? ? e.video ? .arg ? ? "" : e.video ? .arg ? ? "",
    ...
    SR7.migrate.SlideBG = function(e, i, o, l, s = "Slide BG Layer", n = "shape", d = "slidebg") {
        ...
        return void 0 !== e.bg && (m.bg = a(e.bg, e.media, o), "none" !== (e.bg ? .video ? .dotted ? ? e.bg ? .video ? .dottedOverlay ? ? "none") && (m.overlay = {
            ...
            cA: e.bg ? .video ? .dottedColorA ? ? "transparent",
            cB: e.bg ? .video ? .dottedColorB ? ? "#000000"
    ...
    SR7.migrate.translateEase = e => {
        ...
        var m = {
            ...
            content: "text" == a.type || "button" == a.type ? SR7.D.contentOBJ("text", {
                ...
                size: void 0 === a.size ? .covermode ? "100% 100%" : "cover-proportional" == a.size ? .covermode || "cover" == a.size ? .covermode || a.size.originalWidth && a.size.originalHeight && 1e3 * Math.round(a.size.originalWidth / a.size.originalHeight) / 1e3 != Math.round(parseInt(a.size ? .width ? .d ? .v ? ? 1) / parseInt(a.size ? .height ? .d ? .v ? ? 1) * 1e3) / 1e3 ? "cover" : "contain"
                ...
                poster: {
                    ...
                    showOnPause: a.media ? .posterOnPause,
            ...
            pos: {
                x: _tpt.fillArray(_tpt.DNTMtoArr(a.position ? .x ? ? 0, 0), 5),
                y: _tpt.fillArray(_tpt.DNTMtoArr(a.position ? .y ? ? 0, 0), 5),
            ...
            pid: n,
            zIndex: p,
            order: a.group ? .groupOrder ? ? void 0,
            attr: {
                a: a.attributes ? .alt ? ? "",
            ...
            runtime: {
                locked: a.visibility ? .locked ? ? !1,
                hidden: !(a.visibility ? .visible ? ? 1)
            },
            style: a.idle ? .style ? ? "",
        ...
        if ((SR7.E.backend || a.idle ? .rotationX && 0 !== a.idle.rotationX) && (m.tr = m.tr || {}) && (m.tr.rX = a.idle ? .rotationX || 0), (SR7.E.backend || a.idle ? .rotationY && 0 !== a.idle.rotationY) && (m.tr = m.tr || {}) && (m.tr.rY = a.idle ? .rotationY || 0), (SR7.E.backend || a.idle ? .rotationZ && 0 !== a.idle.rotationZ) && (m.tr = m.tr || {}) && (m.tr.rZ = a.idle ? .rotationZ || 0), (SR7.E.backend || a.idle ? .opacity && 0 !== a.idle.opacity) && (m.tr = m.tr || {}) && (m.tr.o = a.idle ? .opacity || 0), (SR7.E.backend || m.tr) && (m.tr.fix = a.idle ? .filtersIOSFix || "d"), "none" !== (a.media ? .dotted ? ? "none") && (m.overlay = {
                ...
                cA: a.media.dottedColorA ? ? "transparent",
                cB: a.media.dottedColorB ? ? "#000000"
        ...
        return (SR7.E.backend || a.idle ? .boxShadow ? .inuse) && (m.bShdw = {
            ...
            h: _tpt.fillArray(_tpt.DNTMtoArr(a.idle ? .textShadow ? .hoffset ? ? 0, 0), 5),
            v: _tpt.fillArray(_tpt.DNTMtoArr(a.idle ? .textShadow ? .voffset ? ? 0, 0), 5),
            blur: _tpt.fillArray(_tpt.DNTMtoArr(a.idle ? .textShadow ? .blur ? ? 0, 0), 5),
    ...
    SR7.migrate.layerListUpdate = e => {
        ...
        if ("mask" == n && 1 == t.use && !0 !== g ? (_.x = _tpt.fillArray(_tpt.DNTMtoArr(t.x ? ? [0, 0, "inherit"][s], [0, 0, "inherit"][s]), 5), _.y = _tpt.fillArray(_tpt.DNTMtoArr(t.y ? ? [0, 0, "inherit"][s], [0, 0, "inherit"][s]), 5), _.oflow = u ? "visible" : "hidden") : "mask" == n && (String(S).includes("scene") || "frame_0" !== v && "frame_1" !== v) && (_.oflow = "visible"), void 0 !== f && (_.rep = {
                s: f.s,
                r: f.r ? ? -1,
                sh: f.sh ? ? !0,
                y: f.y ? ? !1,
        ...
        if (d)
            for (var w in d) {
                ...
                let e;
                if ("content" !== n ? w.includes(n) && (e = w.replace(n, "").toLocaleLowerCase()) : e = w.replace("rotation", "r").replace("skew", "sk"), void 0 !== e)
                    if ("object" == typeof _[e])
                        for (let t = 0; t < 5; t++) "undefined" !== _[e][t] && "inherit" !== _[e][t] && (_[e][t] = "(" + _[e][t] + ")");
                    else void 0 !== _[e] && "inherit" !== _[e] && (_[e] = "(" + _[e] + ")")
            }
        return _
        ...
        for (let e in r.frameOrder)
            for (u of (c = r.frameOrder[e].id, f = r.frames[c], m && m.e !== m.s && "frame_999" == c && (f.timeline.endWithSlide = !0), !m && "frame_999" == c && "" + (f ? .timeline ? .endWithSlide ? ? void 0) == "true" && parseInt(f.timeline ? .start ? ? t) < t && (f.timeline.endWithSlide = !1), "frame_0" !== c && "frame_1" !== c && "frame_999" !== c && 1 == (f.timeline ? .actionTriggered ? ? !1) ? (v = i.tIndex, i.timelines[++i.tIndex] = {
                ...
                if (t.push(_), "frame_999" == c && !f.timeline.endWithSlide && !0 !== f.timeline.actionTriggered) {
                    ...
                    e.push(JSON.parse(JSON.stringify(_)));
                    ...
                    for (let e of ["rX", "rY", "rZ", "skX", "skY", "y", "x"]) {
                        let r = t[t.length - 1] ? .[e];
                        if (r)
                            if ("object" == typeof r)
                                for (let e in r) String(r[e]).includes("(") && String(r[e]).includes(")") && (r[e] = "inherit");
                            else String(r).includes("(") && String(r).includes(")") && (t[t.length - 1][e] = "inherit")
                    }
                }
                i.dif[u] ? ? = {
                    rX: 0,
